...
> [!abstract] 跨学科算法关联
> - **双端对比核心思想**：源自经典算法中的对向双指针技巧，参阅 [[JavaScript 算法/经典 150/经典 150 双指针|经典 150 · 双指针技巧精讲]]；
> - **最长递增子序列 (LIS)**：Vue 3 核心求解最少 DOM 移动步数的底层算法，正是动态规划经典考题，详见 [[JavaScript 算法/经典 150/经典 150 一维动态规划|经典 150 · 300 最长递增子序列 (LIS)]]。
