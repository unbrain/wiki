...
tags:
  ...
  - 数组
  - 双指针
description: 合并有序数组(88)、移除元素(27)等基础题目
aliases:
  - 数字与字符串
---
...
> 🔁 二刷 2026-09-09：一次通过，无卡点。相比旧版改进：跳过 `.` 不再需要 `if(p1 < n1)` 守卫，无条件 `p1++` 越界一次也无妨（外层循环条件会兜住），少一个分支更简洁。

## 相关笔记
- [[LeetCode Hot100 双指针|双指针]]
- [[JavaScript 算法基础第七天|排序算法]]
- [[GRD 字符串|GRD 字符串刷题]]
- [[JavaScript 算法基础第九天|动态规划与贪心]]（跳跃游戏、买卖股票、加油站）